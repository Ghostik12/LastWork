...
using SocialApi.Contracts.Services;
using SocialApi.Contracts.Services.IServices;
using SocialApi.Data;
using SocialApi.Data.Repositories;
...
namespace SocialApi
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                var filepath = Path.Combine(AppContext.BaseDirectory, "SocialApi.xml");
